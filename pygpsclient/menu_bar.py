...
from pygpsclient.strings import MENUFILE, MENUVIEW, MENUOPTION, MENUSAVE, MENULOAD, MENUEXIT, \
...
class MenuBar(Menu):
    ...
    def __init__(self, app, *args, **kwargs):
        ...
        self.view_menu.add_command(label=MENUHIDESE, underline=1,
                                     command=self.__app.toggle_settings)
        self.view_menu.add_command(label=MENUHIDESB, underline=1,
                                     command=self.__app.toggle_status)
        self.view_menu.add_command(label=MENUHIDECON, underline=1,
                                     command=self.__app.toggle_console)
        self.view_menu.add_command(label=MENUHIDEMAP, underline=1,
                                   command=self.__app.toggle_map)
        self.view_menu.add_command(label=MENUHIDESATS, underline=1,
        ...
        self.options_menu.add_command(label=MENUUBXCONFIG, underline=1,
        ...
        self.help_menu.add_command(label=MENUABOUT, underline=1,
