...
ABOUTTXT = "PyGPSClient is a free, open-source NMEA & UBX GPS client application written" \
...
NOWEBMAPERROR2 = "API key not found or invalid."
...
WAITNMEADATA = "Waiting for NMEA data..."
