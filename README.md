...
- Receiver capable of being configured via proprietary NMEA sentences. At time of writing, the only supported GNSS receiver type is the Quectel LG290P, via PQTM* sentences, but additional types may be supported in the underlying NMEA parser library [pynmeagps](https://github.com/semuconsulting/pynmeagps) in later releases.
...
1. Generic configuration panel providing structured updates for supported receivers e.g. the Quectel LG290P via PQTM* sentences.
