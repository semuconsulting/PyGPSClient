...
1. Spectrum widget showing spectrum analysis chart from MON-SPAN messages.
...
![spectrum screenshot](https://github.com/semuconsulting/PyGPSClient/blob/master/images/spectrum.png?raw=true)

*Spectrum analysis chart from MON-SPAN message*
