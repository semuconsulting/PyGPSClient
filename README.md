...
|![rover widget](/images/rover_widget.png) | Rover widget plots the relative 2D position and status information for the roving receiver in a fixed or moving base / rover RTK configuration. Double-click to clear existing plot. **NB:** requires UBX NAV-RELPOSNED messages to be enabled. |
---
