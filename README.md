...
* Supports NMEA, UBX, SBF, RTCM3, NTRIP, SPARTN and TTY (ASCII) protocols.
...
The following example illustrates a series of ASCII SBF configuration commands being sent to a Septentrio Mosaic X5 receiver, followed by successful acknowledgements:
