...
Below is a illustrative NTRIP data log, showing:
...
* corresponding UBX RXM-RTCM acknowledgements generated by the u-blox ZED-F9P receiver, confirming message type, successful use (*msgUsed=2*) and reference station ARP (*refStation=2690*). NB: UBX RXM-RTCM message type must be enabled on the relevant port for this acknowledgement to be received. 
