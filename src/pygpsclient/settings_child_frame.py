...
class SettingsChildFrame(Frame):
    ...
    def _body(self):
        ...
        self.frm_socketclient = SocketConfigFrame(self.__app, self.__container)

        # connection buttons
        self._frm_buttons = Frame(self.__container)
    ...
    def _do_layout(self):
        ...
        ttk.Separator(self.__container).grid(
