...
ICON_POWEROFF = path.join(DIRNAME, "resources/iconmonstr-poweroff-8-24.png")
...
IMPORT = "import"
LBAND = "LBAND"
QUECTEL_LCSERIES = "Quectel LC Series"
QUECTEL_LGSERIES = "Quectel LG Series"
LICENSE_URL = "https://github.com/semuconsulting/PyGPSClient/blob/main/LICENSE"
LIN = "Linux"
MAC = "Darwin"
...
MINFLOAT = -MAXFLOAT
MINDIM = "mindim"
SEPTENTRIO_MOSAIC = "Septentrio Mosaic Series"
MQAPIKEY = "mqapikey"
MQTTIPMODE = 0
MQTTLBANDMODE = 1
...
OVERSCAN = 1.1  # 'overscan' allowance for low resolution screens
...
ROUTE = "route"
RTCMSTR = "1002(1),1006(5),1077(1),1087(1),1097(1),1127(1),1230(1)"
...
UNICORE_UM980 = "Unicore UM9* Series"
UNDO = "UNDO"
UTF8 = "utf-8"
VALBLANK = 1
VALNONBLANK = 2
...
UBLOX_ZEDF9 = "u-blox ZED-F9"
UBLOX_ZEDX20 = "u-blox ZED-X20"
