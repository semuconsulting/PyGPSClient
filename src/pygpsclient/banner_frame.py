...
class BannerFrame(Frame):
    ...
    def _body(self):
        ...
        self._lbl_pdop = Label(
            self._frm_advanced2, bg=self._bgcol, fg="mediumpurple1", width=11, anchor=W
        )
        ...
        self._lbl_hvdop = Label(
            self._frm_advanced2, bg=self._bgcol, fg="mediumpurple1", width=8, anchor=W
        )
        self._lbl_hvacc = Label(
            self._frm_advanced2, bg=self._bgcol, fg="aquamarine2", width=8, anchor=W
        )
